...
namespace IIS.Semya15
{
    ...
    public class Датчик : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Semya15.Контроллер fКонтроллер;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Semya15.Контроллер.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "Контроллер"})]
        public virtual IIS.Semya15.Контроллер Контроллер
        {
            get
            {
                ...
                IIS.Semya15.Контроллер result = this.fКонтроллер;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ДатчикE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДатчикE", typeof(IIS.Semya15.Датчик));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ДатчикL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДатчикL", typeof(IIS.Semya15.Датчик));
                }
            }
        }
    }
    ...
    public class DetailArrayOfДатчик : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Semya15.DetailArrayOfДатчик members)

        // *** End programmer edit section *** (IIS.Semya15.DetailArrayOfДатчик members)
        ...
        /// </summary>
        public DetailArrayOfДатчик(IIS.Semya15.Контроллер fКонтроллер) : 
                base(typeof(Датчик), ((ICSSoft.STORMNET.DataObject)(fКонтроллер)))
        {
        }
        
        public IIS.Semya15.Датчик this[int index]
        {
            get
            {
                return ((IIS.Semya15.Датчик)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Semya15.Датчик dataobject)
        {
