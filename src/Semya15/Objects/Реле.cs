...
namespace IIS.Semya15
{
    ...
    public class Реле : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View РелеE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РелеE", typeof(IIS.Semya15.Реле));
                }
            }
            ...
            public static ICSSoft.STORMNET.View РелеL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РелеL", typeof(IIS.Semya15.Реле));
                }
            }
        }
    }
    ...
    public class DetailArrayOfРеле : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Semya15.DetailArrayOfРеле members)

        // *** End programmer edit section *** (IIS.Semya15.DetailArrayOfРеле members)
        ...
        /// </summary>
        public DetailArrayOfРеле(IIS.Semya15.Контроллер fКонтроллер) : 
                base(typeof(Реле), ((ICSSoft.STORMNET.DataObject)(fКонтроллер)))
        {
        }
        
        public IIS.Semya15.Реле this[int index]
        {
            get
            {
                return ((IIS.Semya15.Реле)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Semya15.Реле dataobject)
        {
